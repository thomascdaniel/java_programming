...
class Customer
	{
		...
		{
			System.out.println("Last Employe ID="+scustId); // This is the example of Static block
			System.out.println("");
		}
...
class Static
			{
				public static/*Directly call by the class name*/ void/*Not returning any value*/ main(String arg[]) throws IOException
				{/*
